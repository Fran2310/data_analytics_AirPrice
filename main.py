import pandas as pd
from scripts import price_days_left, trends_from_destination_cities, airline_popularity, avg_price_airline, price_1_vs_2_days_depature, price_class, dist_price_class, Crr_re_pr, booking_classes_airline
...
#trends_from_destination_cities.graph_gen(data, palette_colors, (11,6))

#price_class.graph_gen(data, palette_colors, (8,6))

#dist_price_class.graph_gen(data, palette_colors, (8,6))

booking_classes_airline.graph_gen(data, palette_colors, size=(8, 6))

#Crr_re_pr.graph_gen(data,palette_colors, (11,6))
