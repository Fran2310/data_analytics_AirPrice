...
"""
Influencia de las Escalas en los precios del boleto por clase

-Se nota un aumento significativo en el precio del boleto cuando los vuelos se lleva a cabo 1 o mas Escalas, esto debido a los gastos operativos que conlleva como tarifas aeroportuarias, 
...
def graph_gen_stops(data, colors, size=(), img=False):
    ...
    #Genera una gráfica de barras que muestra la influencia de las Escalas en el precio promedio.
    
    # Calcular precio promedio por cantidad de Escalas
...
def graph_gen_stops(data, colors, size=(), img=False):
    ...
    info_graph = {
        'title': 'Influencia de las Escalas en el Precio del Vuelo por Clase',
        'x_name': 'Cantidad de Escalas',
        'y_name': 'Precio Promedio (INR)',
        'x_col': 'stops',  # el eje X es la cantidad de Escalas
...
def graph_gen_duration(data, colors, size=(), img=False):
    ...
    #Genera una gráfica de barras que muestra la influencia de las Escalas en la duración promedio.
    
    # Calc duración promedio por cantidad de Escalas
    ...
    info_graph = {
        'title': 'Influencia de las Escalas en la Duración del Vuelo',
        'x_name': 'Cantidad de Escalas',
